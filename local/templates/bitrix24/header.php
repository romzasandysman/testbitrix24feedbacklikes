...
//$asset->addCss(SITE_TEMPLATE_PATH . '/css/vendor/font-assome.css');
$asset->addJs(SITE_TEMPLATE_PATH . '/js/vendor/axios.min.js');
$asset->addJs(SITE_TEMPLATE_PATH . '/js/bootstrap.min.js');
$asset->addJs(SITE_TEMPLATE_PATH . '/js/bootstrap.bundle.min.js');
$asset->addJs(SITE_TEMPLATE_PATH . '/js/feedback.js');
$asset->addCss(SITE_TEMPLATE_PATH . '/css/custom.css');
$asset->addCss(SITE_TEMPLATE_PATH . '/css/vendor/bootstrap.min.css');
$asset->addCss(SITE_TEMPLATE_PATH . '/css/vendor/bootstrap-grid.min.css');
$asset->addCss(SITE_TEMPLATE_PATH . '/css/vendor/bootstrap-reboot.min.css');
?>
...
?>
			<div id="header">
				<div id="header-inner">
                    <div class="wrap-btn-feedback">
                        <button class="btn btn-primary" data-toggle="modal" data-target="#feedback"><?echo Loc::getMessage('FEEDBACK')?></button>
                    </div>
					<?
